#include "Nadafruit_ST77xx.h"
#include "Nadafruit_ST7735.h"
...
static const uint8_t PROGMEM
  ...
  Rcmd1[] = {                 // Init for 7735R, part 1 (red or green tab)
    ...
    ST7735_VMCTR1 , 1      ,  // 12: Power control, 1 arg, no delay:
      0x0E,
    ST77XX_INVON  , 0      ,  // 13: Don't invert display, no args, no delay
...
void Adafruit_ST7735::initR(uint8_t options) {
  ...
  if(options == INITR_GREENTAB) {
    ...
    _colstart = 24;
    _rowstart = 0;
  } else if(options == INITR_MINI160x80_ODD) {
    _height = ST7735_TFTHEIGHT_160;
    _width = ST7735_TFTWIDTH_80;
    displayInit(Rcmd2green160x80);
    _colstart = 26;
  ...
  switch (rotation) {
   case 0:
     ...
     if (tabcolor == INITR_144GREENTAB) {
       _height = ST7735_TFTHEIGHT_128;
       _width  = ST7735_TFTWIDTH_128;
     } else if ((tabcolor == INITR_MINI160x80) || (tabcolor == INITR_MINI160x80_ODD)) {
       _height = ST7735_TFTHEIGHT_160;
       _width = ST7735_TFTWIDTH_80;
     } else {
       _height = ST7735_TFTHEIGHT_160;
